...
# Det vi kan se på kartet som viser arbeidsledighet i Europa er at det er større arbeidsledighet i sør-Europa enn i nord. Det skyldes blant annet at Nord-Norge har større andel offentlige ansatte som ikke rammes av permitteringer, som f.eks under corona-pandemien. En annen grunn til lav arbeidsledighet oppe i nord er at NAV kjører flere tiltak gjennom kjappe kurs og sertifikater for å få folk raskt utdannet og ut i arbeidsmarkedet. De jobber også med å gi ungdom mer langsiktig utdannelse, gjennom videregående skole og fagbrev.
# Myndighetene kan påvirke arbeidsledigheten gjennom stabiliseringspolitikk. Ved høy ledighet kan de stimulere økonomien gjennom en ekspansiv finanspolitikk altså øke offentlige utgifter eller reduserer skatter og avgifter for å stimulere økonomien under en lavkonjunktur, for eksempel ved å øke offentlig forbruk eller ved å gi skattelette.
